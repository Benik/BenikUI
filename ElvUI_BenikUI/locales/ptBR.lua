...
L["Credits:"] = "Créditos"
L['ActionBar BuiStyle Color'] = "Cor do Estilo das Barras de Ações"
L['BenikUI BuiStyle'] = "Estilo BenikUI"
L['Enable/Disable the decorative bars from UI elements'] = "Liga/Desliga as barras decorativas dos elementos da interface"
L['Hide BenikUI BuiStyle'] = "Esconder Estilo BenikUI"
...
L['BuiStyle Color'] = "Cor do Estilo"
...
L['Switch Buttons (requires BenikUI BuiStyle)'] = "Trocar Botões (precisa do Estilo BenikUI)"
...
L['BenikUI BuiStyle on Portrait'] = "Estilo BenikUI no Retrato"
...
L['BuiStyle Height'] = "Altura do estilo"
