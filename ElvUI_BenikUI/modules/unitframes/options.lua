...
local function injectPartyOptions()
	E.Options.args.unitframe.args.groupUnitOptionsGroup.args.party.args.portrait.args.height = {
		type = 'range',
		order = 15,
	...
	E.Options.args.unitframe.args.groupUnitOptionsGroup.args.party.args.portrait.args.transparent = {
		order = 16,
		type = "toggle",
...
local function injectRaidOptions()
	E.Options.args.unitframe.args.groupUnitOptionsGroup.args.raid.args.generalGroup.args.classHover = {
		order = 7,
		type = "toggle",
...
local function injectRaid40Options()
	E.Options.args.unitframe.args.groupUnitOptionsGroup.args.raid40.args.generalGroup.args.classHover = {
		order = 7,
		type = "toggle",
		name = BUI:cOption(L['Class Hover']),
		desc = L['Enable Class color on health border, when mouse over'],
