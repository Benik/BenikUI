		...
		E.Options.args.benikui.args.benikuiDatabars.args[option] = {
			...
			args = {
				enable = {
					...
					type = 'toggle',
					name = L["Enable"],
					get = function(info) return E.db.benikui.benikuiDatabars[option].enable end,
					set = function(info, value) E.db.benikui.benikuiDatabars[option].enable = value E:StaticPopup_Show('PRIVATE_RL'); end,
				},
				spacer1 = {
					order = 2,
					type = 'description',
				...
				buiStyle = {
					...
					disabled = function() return not E.db.benikui.benikuiDatabars[option].enable end,
					get = function(info) return E.db.benikui.benikuiDatabars[option].buiStyle end,
					set = function(info, value) E.db.benikui.benikuiDatabars[option].buiStyle = value; mod:ApplyStyle(bar, option); end,
				},
				buttonStyle = {
					order = 4,
					type = 'select',
					...
					get = function(info) return E.db.benikui.benikuiDatabars[option].buttonStyle end,
					set = function(info, value) E.db.benikui.benikuiDatabars[option].buttonStyle = value; mod:ToggleBackdrop(bar, option); end,
				},
				notifiers = {
					order = 5,
					type = 'group',
					...
					args = {
						enable = {
							...
							type = 'toggle',
							name = L["Enable"],
							get = function(info) return E.db.benikui.benikuiDatabars[option].notifiers.enable end,
							set = function(info, value) E.db.benikui.benikuiDatabars[option].notifiers.enable = value; E:StaticPopup_Show('PRIVATE_RL'); end,
						},
						position = {
							order = 2,
							type = 'select',
							name = L['Position'],
							disabled = function() return not E.db.benikui.benikuiDatabars[option].notifiers.enable end,
							values = positionValues,
							get = function(info) return E.db.benikui.benikuiDatabars[option].notifiers.position end,
							set = function(info, value) E.db.benikui.benikuiDatabars[option].notifiers.position = value; mod:UpdateNotifierPositions(bar, option); end,
						},
					},
				},
				elvuiOption = {
