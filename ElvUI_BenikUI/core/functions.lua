...
local function CreateWideShadow(f)
	...
	wideshadow:SetBackdrop({edgeFile = E.Media.Textures.GlowTex, edgeSize = 6})
...
local function CreateSoftShadow(f)
	...
	shadow:SetBackdrop({edgeFile = E.Media.Textures.GlowTex, edgeSize = db.shadowSize or 3})
...
local function CreateSoftGlow(f)
	...
	sglow:SetBackdrop({edgeFile = E.Media.Textures.GlowTex, edgeSize = 3})
